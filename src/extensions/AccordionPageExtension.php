...
class AccordionPageExtension extends DataExtension
{
    ...
    public function updateCMSFields(FieldList $fields)
    {
        ...
        if (!count($blacklistedPages) || !in_array($this->owner->ClassName, $blacklistedPages, true)) {
            ...
            $gridFieldConfig->addComponent(GridFieldConfigurablePaginator::create());
            ...
            $getGridFieldOrderableRows = $gridFieldConfig->getComponentByType(GridFieldOrderableRows::class);
            $getGridFieldOrderableRows->setRepublishLiveRecords(true);
